...
(không có thì placeholder), catalog nhỏ 8 ô/hàng, tiêu đề trang theo đúng tên
danh mục đang xem, bấm ảnh sản phẩm ra thẳng chi tiết. Tiếng Việt, responsive đầy đủ.

## Có gì cho khách

| Trang | Chức năng |
|---|---|
| Trang chủ `/` | Banner sale, danh mục, gợi ý hôm nay, ưu đãi |
